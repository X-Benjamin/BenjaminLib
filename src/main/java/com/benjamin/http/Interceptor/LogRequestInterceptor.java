...
import static com.benjamin.http.Interceptor.LogResponseInterceptor.bodyEncoded;
import static com.benjamin.http.Interceptor.LogResponseInterceptor.isPlaintext;
...
public class LogRequestInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (requestBody == null) {
            ...
            if (isPlaintext(buffer) && isJson(bodyStr)) {
